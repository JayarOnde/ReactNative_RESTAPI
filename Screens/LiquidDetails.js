...
export default class LiquidDetails extends Component {
                        ...
                        {this.state.glasetSelected ?
                            <View style={{justifyContent: 'flex-end', marginBottom:20,marginTop:10}}>
                                <TouchableOpacity onPress={this.glasseitSelected}>
                                    <View style={styles.buttonNext}>
                                        <Text style={styles.buttonTextNext}>RICHPORT MODIFIED BITUMEN ADHESIVE</Text>
                                        <TouchableOpacity onPress={this.submit}>
                        ...
                        {this.state.glaswtSelected ?
                            <View style={{justifyContent: 'flex-end', marginBottom:20,marginTop:10}}>
                                <TouchableOpacity onPress={this.glasswitSelected}>
                                    <View style={styles.buttonNext}>
                                        <Text style={styles.buttonTextNext}>RICHPORT NON FIBERED ALUMINIUM ROOF COATING</Text>
                                        <TouchableOpacity onPress={this.submit}>
                                            <View style={{ justifyContent: 'flex-end',
                                                alignItems: 'center',
                                                alignSelf:'flex-end',
                                ...
                                <TouchableOpacity onPress={this.glasswitSelected}>
                                    <View style={styles.buttonNext}>
                                        <Text style={styles.buttonTextNext}>RICHPORT NON FIBERED ALUMINIUM ROOF COATING</Text>
                                        <Image source={require('../Images/Aluminium/dropdown.png')} resizeMode="stretch" style={{width: 15, height: 15,top:40,position:'absolute',right:20}}/>
                                    </View>
                                </TouchableOpacity>
                            </View>}
